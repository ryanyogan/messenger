defmodule Messenger.ChatTest do
  ...
  describe "chat_conversation_members" do
    alias Messenger.Chat.ConversationMember
  ...
  describe "chat_message_reactions" do
    alias Messenger.Chat.MessageReaction
  ...
  describe "chat_seen_messages" do
    alias Messenger.Chat.SeenMessage
